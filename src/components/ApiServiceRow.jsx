...
const APIServiceRow = ({ service, onDeleteService, onDeleteInstance, onAddInstance }) => {
  ...
  const handleAddInstanceSubmit = () => {
    onAddInstance(service.id, newInstance.host, newInstance.port);
